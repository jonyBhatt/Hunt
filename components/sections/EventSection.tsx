...
const EventSection = () => {
  return (
    <section className={cn(sans.className,"py-7 bg-[#FAF1FF] container mx-auto")}>
      <div className="flex items-center justify-around flex-col md:flex-row md:text-start text-center">
        <div className={cn("flex flex-col")}>
          <h2 className="font-bold text-2xl">HUNT</h2>
          <span className="tracking-widest text-sm font-bold">events</span>
